...
{
	public static class ImageBitClapper24
	{

		// Decode a image (without alpha channel) into a data object.

		public static SampleDataObject decodeBitClap24( MagickImage image )
		{
		...
		// Encodes a image, it performs circumcision on integers to color the pixels.

		public static void encodeBitCirc24( string file_path, SampleDataObject dat_object, int res_y = 512 )
		{
